...
#pragma warning restore VSTHRD001 // Avoid legacy thread switching APIs
		...
		protected override AutomationPeer OnCreateAutomationPeer() {
			// Returning our raw peer directly avoids the recursive FromElement(this) path
			// that can overflow the stack when UIA asks for the terminal peer during attach.
			return new TermControlAutomationPeer(this);
		}
